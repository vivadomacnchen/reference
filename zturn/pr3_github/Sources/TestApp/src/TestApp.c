...
#endif
// EMIO
//declare GPIO variables
XGpioPs psGpioInstancePtr;
XGpioPs_Config*GpioConfigPtr;
int xStatus;
int iPinNumberEMIO_START = 54; 		// From PS to PL
u32 uPinDirectionEMIO_START = 0x1; 	// Output
...
int main()
{
	...
	// START - Output pin
	// Set the direction of the EMIO and enable
	XGpioPs_SetDirectionPin(&psGpioInstancePtr, iPinNumberEMIO_START, uPinDirectionEMIO_START);
	XGpioPs_SetOutputEnablePin(&psGpioInstancePtr, iPinNumberEMIO_START, 1); // output to PL
